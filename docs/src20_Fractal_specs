...
The protocol specifications for SRC20 on Fractal are identical to those on Bitcoin, except for the ticker name. For native SRC20 protocol details, please refer to: [SRC20 Specifications](https://github.com/stampchain-io/stamps_sdk/blob/main/docs/src20specs.md).
